...
public class MemoServiceImpl implements MemoService {
	...
	public Map<String, Object> memolist(HttpServletRequest request) {
		...
		// 전체 데이터 목록 가져오기 
		List<Map<String, Object>> memolist = memoDAO.memolist();
		Map<String, Object> map = new HashMap<>();
		map.put("totalcount", memocount);
		map.put("memos", memolist);
	...
	public Map<String, Object> memodelete(HttpServletRequest request) {
		...
		// 데이터 베이스에 삽입 삭제 갱신 작업을 행하면 영향받은 행의 개수를 리턴.
		// 0이 리턴되면 잘못된 것이 아니고 조건에 맞는 데이터가 없는 것.
